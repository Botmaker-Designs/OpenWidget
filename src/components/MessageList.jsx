...
export function MessageList({ messages, isTyping, typingMode, typingStates, quickReplies, onQuickReply, onEscalate, onLeaveMessage, fallbackText, agentName }) {
    ...
    <div style={listStyle}>
      ...
      {isTyping && (
        <div style={botBubbleWrap}>
          <TypingIndicator mode={typingMode} agentName={agentName} states={typingStates} />
        </div>
      )}
